...
<body>
    ...
    <div class="contact-box-main">
        <div class="container">
            <div class="row">
                <h2>PRODUCTS (version selection)</h2>
                <?php
                    echo "<br />";
                    echo "<div class='row'>";
                    ...
                    while ($selection = $res_sel->fetch_assoc()) {
                        ...
                        if ($res_elt && $row_elt = $res_elt->fetch_assoc()) {
                            ...
                            $lien = "<a href='affiche_selection.php?sel_numero=" . $sel_numero . "&elt_numero=" . $elt_numero . "' class='btn btn-outline-info' role='button'>Voir</a>";
                        } else {
                            $lien = "<span class = 'text-muted'>Sélection sans éléments</span>";
                        }
                        echo "<tr>";
