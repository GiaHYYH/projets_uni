            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>FORMULAIRE D'INSCRIPRION</h2>
                        <p>Ici, vous pourrez envoyer votre demande d'inscription afin de recevoir votre compte. </p>
                    </div>
                </div>
                    ...
                    <div class="contact-form-right">
                        ...
                        <div class="row">
                            <form action="action.php" method="post">
                                <p>Votre nom : <input type="text" class="form-control" name="nom" required="required"/></p>
                                <p>Votre prénom : <input type="text" class="form-control" name="prenom" required="required"/></p>
                                <p>Votre e-mail (fera office de pseudo): <input type="email" class="form-control" name="pseudo" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" required="required"/></p>
                                <p>Votre mot de passe : <input type="password" class="form-control" name="mdp1" minlength="8" required="required"/></p>
                                <p>Confirmation du mot de passe : <input type="password" class="form-control" name="mdp2" minlength="8" required="required"/></p>
                                <p>Code inscription : <input type="text" class="form-control" name="code" required="required"/></p>
                                <p><input class="btn hvr-hover" type="submit" value="Valider"/></p>
                            </form>
                        </div>
                    </div>
                </div>
