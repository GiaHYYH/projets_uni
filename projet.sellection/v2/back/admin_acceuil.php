...
<?php
    ...
    if ($_SESSION['login'] != 'gEstionnaire1@gmail.com') {
        $requete_profil = "SELECT * FROM t_profil_pro WHERE cpt_mail = '" . $_SESSION['login'] . "';";
        $result = $mysqli->query($requete_profil);
...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="our-link">
                        <a href = "../connexion/session.php"><input type="button" class="btn btn-danger" value="Déconnexion" /></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a href=#><img src="../ressources/<?php echo $struct['pre_logo'] ?>" class="logo" alt=""></a>
                </div>
    ...
    <div class="contact-box-main">
        <div class="container">
            ...
            <?php
                if ($_SESSION['login'] == 'gEstionnaire1@gmail.com') {
                    echo "<p>Bienvenue, <strong>gEstionnaire1</strong> !</p>";
                    echo "<p>Votre pseudo : <strong>" . htmlspecialchars($_SESSION['login']) . "</strong> !</p>";
                    echo "<p>Vous êtes : <strong>Administrateur (Gestionnaire)</strong></p>";
                } else {
                    echo "<p>Bienvenue, <strong>" . $profil['pro_nom'] . " " . $profil['pro_prenom'] . "</strong> !</p>";
                    echo "<p>Votre pseudo : <strong>" . htmlspecialchars($_SESSION['login']) . "</strong> !</p>";
                    echo "<p>Vous êtes : <strong>Administrateur</strong></p>";
                }
            ?>
        </div>
    </div>
