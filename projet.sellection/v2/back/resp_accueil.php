...
<?php
    ...
    if ($result2 == false || $result == false) //Erreur lors de l’exécution de la requête
    { // La requête a echoué
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="our-link">
                        <a href = "../connexion/session.php"><input type="button" class="btn btn-warning" value="Déconnexion" /></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="contact-box-main">
        <div class="container">
            ...
            <?php
                ...
                echo "<p>Vous êtes : <strong>Responsable</strong></p>";
            ?>
        </div>
    </div>
    <!-- End Connexion -->
