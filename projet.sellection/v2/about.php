...
<body>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="noo-sh-title">We are <span>the ARMY Fanshop</span></h2>
                    <p>This website was created by ARMYs for ARMYs. It will display every and all known products that are affiliated with the world-reknown K-Pop group, BTS. It will not, however, sell said items, as this is a fanpage and not an official affiliate of HYBE or any associated companies. There will however be links to official stores where you can buy said items.</p>
                    <p>This website will also share important news, such as the arrival of new merchandise on the website, or upcoming albums.</p>
                </div>
                <div class="col-lg-6">
