                ...
                <?php
                    ...
                    while ($selection = $res_sel->fetch_assoc()) {
                        ...
                        if ($res_elt && $row_elt = $res_elt->fetch_assoc()) {
                            ...
                            $lien = "<a href='affiche_sel.php?sel_numero=" . $sel_numero . "&elt_numero=" . $elt_numero . "' class='btn btn-outline-info' role='button'>Voir</a>";
                        } else {
                            $lien = "<span class = 'text-muted fst-italic'>Sélection sans éléments</span>";
                        }
